...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        openDeleteModal: function openDeleteModal(language) {
            this.deleteModalOpen = true;
        ...
        confirmDelete: function confirmDelete() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default()({
                ...
                if (res.data.success) {
                    _this2.languages = _this2.languages.filter(function (language) {
                        return language.id !== _this2.deleting.id;
                    });
                    _this2.$toasted.show(_this2.__('Language deleted'), { type: 'success' });
                    _this2.closeDeleteModal();
                } else {
                    _this2.$toasted.show(_this2.__('An error occurred, try again ...'), { type: 'error' });
                    _this2.closeDeleteModal();
                }
            }).catch(function (err) {
                _this2.$toasted.show(_this2.__('An error occurred, try again ...'), { type: 'error' });
                    ...
                    [
                      ...
                      _c(
                        ...
                        _vm._l(_vm.languages, function(language) {
                          return _c("tr", { key: "language-" + language.id }, [
                            _c("td", [_vm._v(_vm._s(language.name))]),
                            _vm._v(" "),
                            ...
                            _c(
                              ...
                              [
                                  ...
                                  "router-link",
                                  {
                                    ...
                                    attrs: {
                                      to: {
                                        ...
                                        title: _vm.__("View translations"),
                                        query: {
                                ...
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "appearance-none mr-3 text-70 hover:text-danger",
                                    attrs: { title: "Delete" },
                                    on: {
                                      click: function($event) {
                                        $event.preventDefault()
                                        return _vm.openDeleteModal(language)
                                      }
                                    }
                                  },
                            ...
                            _vm._v(
                              "\n                        " +
                                ...
                                _vm._s(
                                  _vm.deleting.name
                                    ? _vm.deleting.name
                                    : _vm.deleting.language
                                ) +
                                "), " +
                                _vm._s(
                                  _vm.__(
                                    "matching translations will delete too"
                                  )
                                ) +
                                ".\n                    "
                            )
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-3" }, [
        _vm._v(_vm._s(_vm.__("Add new language")))
      ]),
      _vm._v(" "),
            ...
            _c("div", { staticClass: "bg-30 flex px-8 py-4" }, [
              _c(
                ...
                [
                  _vm._v(
                    "\n                " +
                      _vm._s(_vm.__("Add this language")) +
                      "\n            "
                  )
                ]
              )
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_TranslationInput_vue__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(11);
...
var update = __webpack_require__(47)("3f492afe", content, false, {});
        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              attrs: { placeholder: "Rechercher", type: "search" },
                ...
                [
                  ...
                  _c("div", { staticClass: "p-2" }, [
                    _c(
                      ...
                      _vm._l(_vm.languages, function(languageItem) {
                        return _c(
                          "option",
                          {
                            key: "filter-language-" + languageItem.language,
                            domProps: { value: languageItem.language }
                          },
                          [
                            _vm._v(
                              "\n                            " +
